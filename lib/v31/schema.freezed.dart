...
@JsonKey(name: 'deprecated') bool? get $deprecated;/// Vendor extensions (keys like `x-*`).
...
class _Schema extends Schema {
  const _Schema({@JsonKey(name: r'$ref') this.ref, @JsonKey(includeFromJson: false, includeToJson: true) this.type, this.format, this.title, this.description, @JsonKey(name: 'required') final  List<String>? $required, final  Map<String, Schema>? properties, this.items, this.example, final  List<dynamic>? examples, @JsonKey(name: 'enum') final  List<dynamic>? enumValues, @JsonKey(name: 'default') this.$default, this.xml, this.additionalProperties, this.maximum, this.exclusiveMaximum, this.minimum, this.exclusiveMinimum, this.externalDocs, this.discriminator, final  List<Schema>? allOf, final  List<Schema>? oneOf, final  List<Schema>? anyOf, this.not, this.nullable, this.readOnly, this.writeOnly, this.allowEmptyValue, this.collectionFormat, this.maxLength, this.minLength, this.maxItems, this.minItems, this.pattern, this.uniqueItems, this.maxProperties, this.minProperties, this.multipleOf, @JsonKey(name: 'deprecated') this.$deprecated, @JsonKey(includeIfNull: false, includeFromJson: false, includeToJson: false) final  Map<String, dynamic>? extensions, this.$id, this.$schema, this.$vocabulary, this.$anchor, this.$dynamicAnchor, this.$dynamicRef, final  Map<String, Schema>? $defs, this.contentMediaType, this.contentEncoding, @JsonKey(name: 'swagger-extension') this.swaggerExtension, @JsonKey(name: 'const') this.const$, final  Map<String, Schema>? patternProperties, this.unevaluatedProperties}): _$required = $required,_properties = properties,_examples = examples,_enumValues = enumValues,_allOf = allOf,_oneOf = oneOf,_anyOf = anyOf,_extensions = extensions,_$defs = $defs,_patternProperties = patternProperties,super._();
