...
_Schema _$SchemaFromJson(Map<String, dynamic> json) => _Schema(
  ...
  $dynamicRef: json[r'$dynamicRef'] as String?,
  $defs: (json[r'$defs'] as Map<String, dynamic>?)?.map(
    (k, e) => MapEntry(k, Schema.fromJson(e as Map<String, dynamic>)),
  ),
  ...
  unevaluatedProperties: json['unevaluatedProperties'] as bool?,
);
...
Map<String, dynamic> _$SchemaToJson(_Schema instance) => <String, dynamic>{
  ...
  if (instance.$id case final value?) r'$id': value,
  if (instance.$schema case final value?) r'$schema': value,
  if (instance.$vocabulary case final value?) r'$vocabulary': value,
  if (instance.$anchor case final value?) r'$anchor': value,
  if (instance.$dynamicAnchor case final value?) r'$dynamicAnchor': value,
  if (instance.$dynamicRef case final value?) r'$dynamicRef': value,
  if (instance.$defs?.map((k, e) => MapEntry(k, e.toJson())) case final value?)
    r'$defs': value,
  ...
  if (instance.unevaluatedProperties case final value?)
