...
class _Info extends Info {
  const _Info({required this.title, required this.version, this.description, this.termsOfService, this.contact, this.license, this.summary, @JsonKey(includeIfNull: false, includeFromJson: false, includeToJson: false) final  Map<String, dynamic>? extensions}): _extensions = extensions,super._();
