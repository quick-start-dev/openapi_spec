...
/// The definition for the `GET` operation.
 ...
 Operation? get patch;/// The definition for the `HEAD` operation.
 Operation? get head;/// The definition for the `OPTIONS` operation.
 Operation? get options;/// The definition for the `TRACE` operation.
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PathItem&&(identical(other.get, get) || other.get == get)&&(identical(other.post, post) || other.post == post)&&(identical(other.put, put) || other.put == put)&&(identical(other.delete, delete) || other.delete == delete)&&(identical(other.patch, patch) || other.patch == patch)&&(identical(other.head, head) || other.head == head)&&(identical(other.options, options) || other.options == options)&&(identical(other.trace, trace) || other.trace == trace)&&(identical(other.ref, ref) || other.ref == ref)&&(identical(other.summary, summary) || other.summary == summary)&&(identical(other.description, description) || other.description == description)&&const DeepCollectionEquality().equals(other.servers, servers)&&const DeepCollectionEquality().equals(other.parameters, parameters)&&const DeepCollectionEquality().equals(other.extensions, extensions));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,get,post,put,delete,patch,head,options,trace,ref,summary,description,const DeepCollectionEquality().hash(servers),const DeepCollectionEquality().hash(parameters),const DeepCollectionEquality().hash(extensions));

@override
String toString() {
  return 'PathItem(get: $get, post: $post, put: $put, delete: $delete, patch: $patch, head: $head, options: $options, trace: $trace, ref: $ref, summary: $summary, description: $description, servers: $servers, parameters: $parameters, extensions: $extensions)';
}
...
$OperationCopyWith<$Res>? get get;$OperationCopyWith<$Res>? get post;$OperationCopyWith<$Res>? get put;$OperationCopyWith<$Res>? get delete;$OperationCopyWith<$Res>? get patch;$OperationCopyWith<$Res>? get head;$OperationCopyWith<$Res>? get options;$OperationCopyWith<$Res>? get trace;
...
/// Create a copy of PathItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? get = freezed,Object? post = freezed,Object? put = freezed,Object? delete = freezed,Object? patch = freezed,Object? head = freezed,Object? options = freezed,Object? trace = freezed,Object? ref = freezed,Object? summary = freezed,Object? description = freezed,Object? servers = freezed,Object? parameters = freezed,Object? extensions = freezed,}) {
...
as List<Server>?,parameters: freezed == parameters ? _self.parameters : parameters // ignore: cast_nullable_to_non_nullable
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PathItem&&(identical(other.get, get) || other.get == get)&&(identical(other.post, post) || other.post == post)&&(identical(other.put, put) || other.put == put)&&(identical(other.delete, delete) || other.delete == delete)&&(identical(other.patch, patch) || other.patch == patch)&&(identical(other.head, head) || other.head == head)&&(identical(other.options, options) || other.options == options)&&(identical(other.trace, trace) || other.trace == trace)&&(identical(other.ref, ref) || other.ref == ref)&&(identical(other.summary, summary) || other.summary == summary)&&(identical(other.description, description) || other.description == description)&&const DeepCollectionEquality().equals(other._servers, _servers)&&const DeepCollectionEquality().equals(other._parameters, _parameters)&&const DeepCollectionEquality().equals(other._extensions, _extensions));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,get,post,put,delete,patch,head,options,trace,ref,summary,description,const DeepCollectionEquality().hash(_servers),const DeepCollectionEquality().hash(_parameters),const DeepCollectionEquality().hash(_extensions));
...
@override $OperationCopyWith<$Res>? get get;@override $OperationCopyWith<$Res>? get post;@override $OperationCopyWith<$Res>? get put;@override $OperationCopyWith<$Res>? get delete;@override $OperationCopyWith<$Res>? get patch;@override $OperationCopyWith<$Res>? get head;@override $OperationCopyWith<$Res>? get options;@override $OperationCopyWith<$Res>? get trace;
...
/// Create a copy of PathItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? get = freezed,Object? post = freezed,Object? put = freezed,Object? delete = freezed,Object? patch = freezed,Object? head = freezed,Object? options = freezed,Object? trace = freezed,Object? ref = freezed,Object? summary = freezed,Object? description = freezed,Object? servers = freezed,Object? parameters = freezed,Object? extensions = freezed,}) {
...
as List<Server>?,parameters: freezed == parameters ? _self._parameters : parameters // ignore: cast_nullable_to_non_nullable
