...
/// following the naming constraints of the names for Component Objects.
 Map<String, Link>? get links;/// Vendor extensions (keys like `x-*`).
...
@useResult
$Res call({
 String description, Map<String, MediaType>? content, Map<String, Header>? headers, Map<String, Link>? links,@JsonKey(includeIfNull: false, includeFromJson: false, includeToJson: false) Map<String, dynamic>? extensions
});
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String description,  Map<String, MediaType>? content,  Map<String, Header>? headers,  Map<String, Link>? links, @JsonKey(includeIfNull: false, includeFromJson: false, includeToJson: false)  Map<String, dynamic>? extensions)  $default,) {final _that = this;
switch (_that) {
case _Response():
return $default(_that.description,_that.content,_that.headers,_that.links,_that.extensions);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String description,  Map<String, MediaType>? content,  Map<String, Header>? headers,  Map<String, Link>? links, @JsonKey(includeIfNull: false, includeFromJson: false, includeToJson: false)  Map<String, dynamic>? extensions)?  $default,) {final _that = this;
switch (_that) {
case _Response() when $default != null:
return $default(_that.description,_that.content,_that.headers,_that.links,_that.extensions);case _:
  return null;
...
class _Response extends Response {
  const _Response({required this.description, final  Map<String, MediaType>? content, final  Map<String, Header>? headers, final  Map<String, Link>? links, @JsonKey(includeIfNull: false, includeFromJson: false, includeToJson: false) final  Map<String, dynamic>? extensions}): _content = content,_headers = headers,_links = links,_extensions = extensions,super._();
