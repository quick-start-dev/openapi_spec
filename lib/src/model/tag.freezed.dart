...
@JsonKey(includeIfNull: false) String? get description;/// External documentation for this tag.
@JsonKey(includeIfNull: false) ExternalDocs? get externalDocs;
...
@useResult
$Res call({
 String name,@JsonKey(includeIfNull: false) String? description,@JsonKey(includeIfNull: false) ExternalDocs? externalDocs
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name, @JsonKey(includeIfNull: false)  String? description, @JsonKey(includeIfNull: false)  ExternalDocs? externalDocs)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Tag() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name, @JsonKey(includeIfNull: false)  String? description, @JsonKey(includeIfNull: false)  ExternalDocs? externalDocs)  $default,) {final _that = this;
switch (_that) {
case _Tag():
return $default(_that.name,_that.description,_that.externalDocs);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name, @JsonKey(includeIfNull: false)  String? description, @JsonKey(includeIfNull: false)  ExternalDocs? externalDocs)?  $default,) {final _that = this;
switch (_that) {
case _Tag() when $default != null:
return $default(_that.name,_that.description,_that.externalDocs);case _:
  return null;
...
class _Tag implements Tag {
  const _Tag({required this.name, @JsonKey(includeIfNull: false) this.description, @JsonKey(includeIfNull: false) this.externalDocs});
...
@override@JsonKey(includeIfNull: false) final  ExternalDocs? externalDocs;
