...
import 'package:openapi_spec/v30.dart';
...
void matchSpecV30WithJson(OpenAPI spec, Map<String, dynamic> orgJson) {
  ...
  for (var i = 0; i < spec.servers.length; i++) {
    ...
    expect(spec.servers[i].description, orgJson['servers'][i]['description']);
  }
